      ...
      <section className="flex flex-col justify-center items-center w-full px-[44px] lg:px-[140px]">
        ...
        <div className="grid grid-cols-2 place-items-center gap-3 lg:flex lg:flex-row w-full lg:justify-center lg:items-center mb-[40px]">
          <figure className="relative group">
            <img  src="https://res.cloudinary.com/dsy1vfp2c/image/upload/v1729330625/lookbook1.webp" alt="lookbook 1" className="w-[200px] h-[150px] lg:w-[273px] lg:h-[273px] object-cover object-center lg:mx-[24px]"/>
          ...
          <figure className="relative group">
            <img  src="/home/lookbook2.jpg" alt="lookbook 2" className="w-[200px] h-[150px] lg:w-[273px] lg:h-[273px] object-cover object-right lg:mx-[24px]"/>
          ...
          <figure className="relative group">
            <img  src="https://res.cloudinary.com/dsy1vfp2c/image/upload/v1729330636/lookbook3.webp" alt="lookbook 3" className="w-[200px] h-[150px] lg:w-[273px] lg:h-[273px] object-cover lg:mx-[24px]"/>
          ...
          <figure className="relative group">
            <img  src="https://res.cloudinary.com/dsy1vfp2c/image/upload/v1729330645/lookbook4.webp" alt="lookbook 4" className="w-[200px] h-[150px] lg:w-[273px] lg:h-[273px] object-cover object-center lg:mx-[24px]"/>
      ...
      <section className="max-md:grid w-full px-[16px] lg:px-[255px] lg:min-h-[680px] max-md:py-[50px] lg:py-[55px]">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-around max-md:mb-[40px] lg:space-x-[90px] max-md:space-y-[15px]">
          <div className="max-md:py-5 max-md:space-x-[16px] max-md:flex max-md:items-center lg:grid lg:place-items-center lg:h-[300px] lg:px-[25px] lg:pt-[25px] group bg-[#f9ebeb] lg:bg-opacity-0 lg:transition-all lg:duration-500 lg:ease-in-out lg:hover:bg-opacity-100 lg:transform lg:hover:h-[430px] lg:hover:shadow-[8px_8px_10px_0px_rgba(0,0,0,0.1)]">
            <img  alt="service 1" src="https://res.cloudinary.com/dsy1vfp2c/image/upload/v1729330661/service_1.webp" className="max-md:ml-8 rounded-full h-[100px] w-[100px] lg:h-[200px] lg:w-[200px] object-cover"/>
          ...
          <div className="max-md:py-5 max-md:space-x-[16px] max-md:flex max-md:items-center lg:grid lg:place-items-center lg:h-[300px] lg:px-[25px] lg:pt-[25px] group bg-[#f9ebeb] lg:bg-opacity-0 lg:transition-all lg:duration-500 lg:ease-in-out lg:hover:bg-opacity-100 lg:transform lg:hover:h-[430px] lg:hover:shadow-[8px_8px_10px_0px_rgba(0,0,0,0.1)]">
            <img  src="https://res.cloudinary.com/dsy1vfp2c/image/upload/v1729330665/service_2.webp" alt="service 2" className="max-md:ml-8 rounded-full h-[100px] w-[100px] lg:h-[200px] lg:w-[200px] object-cover"/>
            <div className="max-md:w-1/2 max-md:grow">
          ...
          <div className="max-md:py-5 max-md:space-x-[16px] max-md:flex max-md:items-center lg:grid lg:place-items-center lg:h-[300px] lg:px-[25px] lg:pt-[25px] group bg-[#f9ebeb] lg:bg-opacity-0 lg:transition-all lg:duration-500 lg:ease-in-out lg:hover:bg-opacity-100 lg:transform lg:hover:h-[430px] lg:hover:shadow-[8px_8px_10px_0px_rgba(0,0,0,0.1)]">
          <img  src="https://res.cloudinary.com/dsy1vfp2c/image/upload/v1729330685/service_3.webp" alt="service 3" className="max-md:ml-8 rounded-full h-[100px] w-[100px] lg:h-[200px] lg:w-[200px] object-cover object-top"/>
            <div className="max-md:w-1/2 max-md:grow">
